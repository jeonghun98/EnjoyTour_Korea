...
- **URL** : http://localhost/swagger-ui/index.html
- **Models** :  HotplaceDto (핫플레이스 정보)
    
    ![Untitled 22](https://user-images.githubusercontent.com/68097374/235869114-36ee79bb-642b-49be-9289-523bcaeab9a8.png)
    
- **Hotplace Controller (핫플레이스 관리)**
    
    
    | hotplaceList | GET | /hotplace/ |
    | --- | --- | --- |
    | hotplaceWrite | POST | /hotplace/ |
    | hotplaceModify | PUT | /hotplace/ |
    | hotplaceDelete | DELETE | /hotplace/{hotplaceno} |
    - **hotplaceList** : 핫플레이스의 **전체 목록**을 리턴합니다
        ...
        [
          ...
          },
          {
            ...
            "content": "핫플레이스입니다.",
            "like": 0,
            "date": "2023-04-14 20:42:28",
            "img": "image.jpg"
          }
        ]
        ```
        
    - **hotplaceWrite** :  핫플레이스를 **등록**합니다
